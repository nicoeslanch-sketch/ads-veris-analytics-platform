...
test('Fase 17 procesa, combina, relaciona y exporta un libro multihoja', async ({ page }, testInfo) => {
  ...
  await page.goto('/estandarizacion')
    ...
    await page.getByRole('button', { name: /Apilar tablas compatibles/ }).click()
    ...
    await page.getByRole('button', { name: /Relacionar tablas/ }).click()
    ...
    await page.getByRole('button', { name: /Apilar y luego relacionar/ }).click()
