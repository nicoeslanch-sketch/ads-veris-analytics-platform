...
ARTICLES: list[dict[str, Any]] = [
    ...
    article("storage_quota", "datos", "Cuota de almacenamiento", ["cuota de almacenamiento", "almacenamiento lleno", "espacio lleno", "storage quota", "error 507", "espacio disponible", "cuantos archivos puedo guardar"], "Consulta el espacio usado en Configuración, Almacenamiento. La cuota cuenta originales y artefactos guardados; las subidas pendientes también reservan espacio. Si se alcanza, se rechazan nuevas escrituras sin borrar tus archivos existentes. Libera espacio desde Historial. La cuota no cambia las reglas de limpieza ni elimina duplicados.", "¿El aviso aparece al subir o al descargar?", 88),
